...
import LengthwiseCard from 'src/components/main/common/LengthwiseCard';
import WidthwiseCard from 'src/components/main/common/WidthwiseCard';
...
import allow from 'src/assets/right-arrow.svg';
