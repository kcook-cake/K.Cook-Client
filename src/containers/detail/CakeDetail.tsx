  ...
  useEffect(() => {
    ...
    axios({
      ...
      .then((res) => {
        ...
        option = List2Option(data.optionsList);
        setOption(option);
        console.log(option);
        ...
        <div className="cake-detail-inner">
          <div className="cake-detail-left">
            <div className="cake-detail-main-img">
              <div className="cake-detail-main-img-inner">
                {image !== null ? <img src={image} /> : <div>~준비중~</div>}
              </div>
            </div>
          ...
          <div className="cake-detail-right">
            ...
            <div
              ...
              style={{
                height: heightTF ? height - 50 + 'px' : 'auto',
              }}
            >
              <div className="cake-detail-right-box">
                <Link to="/Store/0">
                  <div className="cake-detail-right-store">
                    {true ? <img src={cake6} /> : <img src={profile} />}
                    <div className="cake-detail-right-store-name">
                      {data.storeName} &gt;
                    </div>
                  </div>
                </Link>
                <div className="cake-detail-right-store-cake">{data.name}</div>
