...
function SPMCard_Add({ NumF, resize, setAddShowF }: Props) {
  ...
  const handleOptionListPrice = (e: any, optionId: any, optionListId: any) => {
    addOption[optionId].itemList[optionListId].itemPrice = parseInt(
  ...
  return (
    <>
      <ImageModal
        ...
        resize={resize}
        TF={true}
        imageModalShow={addImgModal}
        setImageModalShowF={setAddImgModal}
        imageData={addImage}
      />
            ...
            <div>
              ...
              >
                <div className="spm-add-update-img-inner">
                  {addImage[addImgNum] === '' ||
                  addImage[addImgNum] === null ||
                  addImage[addImgNum] === undefined ? (
              ...
              <div className="spm-add-update-show">
                당일 판매
                <select onChange={(e) => setAddMax(e.target.value)}>
                  <option>무한</option>
                  <option>1</option>
                </select>
                개{/* <input value={1}/> */}
            ...
            <div>
              ...
              {addChildOption > -1 && (
                <div className="spm-add-update-child-modal">
                  {addOption.map(
                    (option2: { optionNumber: any; itemList: any }) => {
                      return (
                        <>
                          {option2.itemList.map(
                            (item2: { itemNumber: any; itemName: any }) => {
                              return (
                                addChildOption < option2.optionNumber && (
                                  <div
                                    className={classNames('', {
                                      'spm-add-update-child-modal-none':
                                        addOption[addChildOption].itemList[
                                          addChildItem
                                        ].itemChild.find((data: any) => {
                                          if (
                                            data.array.find((data2: any) => {
                                              if (
                                                data.type ===
                                                  option2.optionNumber &&
                                                data2 === item2.itemNumber
                                              )
                                                return true;
                                            }) !== undefined
                                          )
                                    ...
                                    onClick={() => {
                                      ...
                                      for (var i = 0; i < child.length; i++) {
                                        if (
                                          child[i].type === option2.optionNumber
                                        ) {
                                          addOption[addChildOption].itemList[
                                            addChildItem
                                          ].itemChild[i].array.push(
                                            item2.itemNumber
                                          );
                                          console.log(child);
                                          setAddChildOption(-1);
              ...
              <div className="spm-add-update-price">
                ...
                />
                원<div className="spm-add-update-item-right">x</div>
              </div>
              {addOption.map(
                (option: {
                  optionNumber: any;
                    ...
                    <form>
                      <div className="spm-add-update-option">
                        <input
                          ...
                          onChange={(e) => {
                            handleOptionName(e, option.optionNumber);
                          }}
                        />
                        <div
                                ...
                                <div
                                  ...
                                  onDragEnd={(e) => {
                                    ...
                                    if (
                                      ...
                                      for (var i = n; i > 0; i--)
                                        addOption[option.optionNumber].itemList[
                                          item.itemNumber - i
                                        ].itemNumber =
                                          item.itemNumber - (i - 1);
