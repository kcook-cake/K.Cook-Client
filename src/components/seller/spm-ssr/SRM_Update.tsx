          ...
          <div className="spm-add-update-content">
              ...
              >
                <div className="spm-add-update-img-inner">
                  {updateImage[updateImageNum] === '' ? (
                    ...
                    <>
                      <img src={updateImage[updateImageNum]} alt="ori-img" />
                    </>
                  )}
                </div>
              </div>
            ...
            <div>
              ...
              <div className="spm-add-update-price">
                ...
                />
                원<div className="spm-add-update-right">x</div>
              </div>
              <>
                {updateOption.map(
                  (option: {
                      ...
                      <form>
                        <div className="spm-add-update-option">
                          <input
                            ...
                            onChange={(e) => {
                              handleOptionName(e, option.optionId);
                            }}
                          />
                          <div
                              ...
                              <div className="spm-add-update-item">
                                    ...
                                    if (
                                      ...
                                      for (var i = n + 1; i > 1; i--) {
                                        updateOption[
                                          ...
                                          optionList.optionListId - i
                                        ].optionListId =
                                          optionList.optionListId - (i - 2);
                                      }
                                      updateOption[
                                        option.optionId - 1
                                      ].optionList[
                                        optionList.optionListId - 1
                                      ].optionListId =
                                        optionList.optionListId - n;
                                      updateOption[
                                        option.optionId - 1
                                      ].optionList.sort((a: any, b: any) => {
                                        if (a.optionListId < b.optionListId)
                                          return -1;
                                        if (a.optionListId > b.optionListId)
                                          return 1;
                                        return 0;
                                ...
                                <div style={{ width: '100%' }}>
                                  <input
                                    ...
                                    placeholder={
                                      optionList.optionListName.split(
                                        '&'
                                      )[0] === '텍스트'
                                        ? '텍스트 입력'
                                        : option.optionImage &&
                        ...
                        <div className="spm-add-update-item-button">
                          <div
                            onClick={() => {
                              updateOption[option.optionId - 1].optionList[
                                option.optionList.length
                              ] = {
